          ...
          <div className="container">
            ...
            <div className="box-nav-tabs mt-40 mb-5">
              <ul className="nav" role="tablist">
                <li>
                  <span className="btn btn-border aboutus-icon mr-15 mb-5 active" onClick={() => handleOnClick(1)}>
                    Short Bio
                  </span>
                </li>
                <li>
                  <span className="btn btn-border recruitment-icon mr-15 mb-5" onClick={() => handleOnClick(2)}>
                    Skills
                  </span>
                </li>
                <li>
                          ...
                          <div className="card-2-bottom mt-20">
                            <div className="row">
                              ...
                              <div className="col-lg-5 col-5 text-end">
                                <Link href="job-details">
                                  <span className="btn btn-apply-now">View Details</span>
                                </Link>
                              </div>
                            </div>
                          </div>
