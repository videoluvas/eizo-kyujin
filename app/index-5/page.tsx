                ...
                <div className="row">
                  <div className="col-xl-7 col-lg-12">
                    <div className="block-banner">
                      ...
                      <div className="mt-30">
                        <span className="btn btn-default mr-15">Get Started</span>

                        <span className="btn btn-border-brand-2">Learn more</span>
                      </div>
              ...
              <div className="row">
                <div className="col-xl-5">
                  <div className="pt-70">
                    ...
                    <div className="mt-20">
                      <span className="btn btn-brand-1 btn-icon-more hover-up">Explore</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="pl-30">
                    ...
                    <div className="mt-20">
                      <span className="btn btn-default">Create Profile</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="section-box mt-70 mb-40">
            <div className="container">
              ...
              <div className="mt-50 text-center">
                <span className="btn btn-default">Get Started</span>
              </div>
            </div>
          </section>
