            ...
            <div className="container">
              <div className="box-white">
                <div className="max-width-single">
                  <Link href="#">
                    <span className="btn btn-tag">Job Tips</span>
                  </Link>
                    ...
                    <div className="single-apply-jobs mt-20">
                      <div className="row">
                        <div className="col-lg-7">
                          <Link href="#">
                            <span className="btn btn-border-3 mr-10 hover-up"># Nature</span>
                          </Link>

                          <Link href="#">
                            <span className="btn btn-border-3 mr-10 hover-up"># Beauty</span>
                          </Link>

                          <Link href="#">
                            <span className="btn btn-border-3 hover-up"># Travel tips</span>
                          </Link>
                        </div>
                        <div className="col-md-5 text-lg-end social-share">
                          ...
                          <Link href="#">
                            <span className="mr-20 d-inline-block d-middle hover-up">
                          ...
                          <Link href="#">
                            <span className="mr-0 d-inline-block d-middle hover-up">
